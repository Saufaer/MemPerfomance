...
try:
    ...
    #print(int("4320d1",16))
    event_attr.sample_type = PerfEventSampleFormat.ADDR
    #event_attr.sample_type = int("7df",16) #Enable PERF_SAMPLE_ADDR
    #print(int("7df",16))
    event_attr.sample_period = 100000
    ...
    exit()
#print("Running for 10 seconds or hit Ctrl-C to end.")
sleep(8)
